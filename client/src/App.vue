...
import { MainComponents, MainComponentsKeys } from '@/components/main-components-list'
import SessionList from '@/components/SessionList.vue'
import { type Session } from '@/infra/sessions/types'
import { ref } from 'vue'
...
const currentMainComponentKey = ref<string | null>(null)
...
const setMainComponent = (componentKey: string) => {
  console.log(componentKey)
  currentMainComponentKey.value = componentKey
}
</script>
...
<template>
  <main>
    <SessionList
      ...
      @go-create-session="setMainComponent(MainComponentsKeys.CreateSession)"
    ></SessionList>
    <div class="divider lg:divider-horizontal"></div>
    <div class="main-section p-4">
      <component
        v-if="currentMainComponentKey"
        :is="MainComponents[currentMainComponentKey]"
      ></component>
      <h2 v-else class="text-2xl text-center">Тут пока пусто</h2>
    </div>
  </main>
</template>
